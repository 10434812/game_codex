  ...
  skin: [
    {
      ...
      skinIcon: '🎴',
      skinImage: '/assets/skins/skin-01.png',
      rarity: 'base',
      theme: '经典',
    },
    {
      id: 'skin-panda-scholar',
      category: 'skin',
      name: '文墨熊尊',
      price: 1280,
      accent: '#6f6f73',
      description: '持卷而立，稳重中自带威仪。',
      skinClass: 'skin-default',
      skinIcon: '🐼',
      skinImage: '/assets/skins/skin-03.png',
      rarity: 'common',
      theme: '文雅',
    },
    {
      ...
      skinIcon: '🐇',
      skinImage: '/assets/skins/skin-05.png',
      rarity: 'common',
      theme: '灵秀',
    },
    {
      ...
      skinClass: 'skin-default',
      skinIcon: '🧘',
      skinImage: '/assets/skins/skin-09.png',
      rarity: 'common',
      theme: '禅意',
    },
    {
      ...
      skinIcon: '🦉',
      skinImage: '/assets/skins/skin-13.png',
      rarity: 'common',
      theme: '谋略',
    },
    {
      ...
      skinClass: 'skin-default',
      skinIcon: '📜',
      skinImage: '/assets/skins/skin-19.png',
      rarity: 'common',
      theme: '谋略',
    },
    {
      ...
      skinIcon: '🐠',
      skinImage: '/assets/skins/skin-20.png',
      rarity: 'common',
      theme: '水灵',
    },
    {
      ...
      skinClass: 'skin-sakura',
      skinIcon: '🌸',
      skinImage: '/assets/skins/skin-08.png',
      rarity: 'rare',
      theme: '仙灵',
    },
    {
      ...
      skinClass: 'skin-sakura',
      skinIcon: '🦊',
      skinImage: '/assets/skins/skin-02.png',
      rarity: 'rare',
      theme: '瑞兽',
    },
    {
      ...
      skinClass: 'skin-sunrise',
      skinIcon: '🐯',
      skinImage: '/assets/skins/skin-04.png',
      rarity: 'rare',
      theme: '武将',
    },
    {
    ...
    },
    {
      ...
      skinClass: 'skin-storm',
      skinIcon: '🦌',
      skinImage: '/assets/skins/skin-16.png',
      rarity: 'rare',
      theme: '瑞兽',
    },
    {
      id: 'skin-antler-spirit',
      category: 'skin',
      name: '青角灵兽',
      price: 2280,
      accent: '#6dc6c9',
      description: '灵角映月，守望旅途中每次冒险。',
      skinClass: 'skin-storm',
      skinIcon: '🦌',
      skinImage: '/assets/skins/skin-10.png',
      rarity: 'rare',
      theme: '瑞兽',
    },
    {
      ...
      price: 2280,
      accent: '#5bb5ae',
      description: '护身灵狮，点亮关键回合的气势。',
      skinClass: 'skin-storm',
      skinIcon: '🦁',
      skinImage: '/assets/skins/skin-15.png',
      rarity: 'rare',
      theme: '瑞兽',
    },
    {
      id: 'skin-golden-monkey',
      category: 'skin',
      name: '金猴执印',
      price: 2280,
      accent: '#e0a451',
      description: '机敏果敢，擅长在混战中破局。',
      skinClass: 'skin-sunrise',
      skinIcon: '🐵',
      skinImage: '/assets/skins/skin-11.png',
      rarity: 'rare',
      theme: '神话',
    },
    {
      ...
      price: 2280,
      accent: '#ef9358',
      description: '水光流转，象征顺遂与好运。',
      skinClass: 'skin-sunrise',
      skinIcon: '🐟',
      skinImage: '/assets/skins/skin-14.png',
      rarity: 'rare',
      theme: '水灵',
    },
    {
      ...
      skinClass: 'skin-sunrise',
      skinIcon: '🌞',
      skinImage: '/assets/skins/skin-07.png',
      rarity: 'legendary',
      theme: '尊耀',
    },
    {
      id: 'skin-crane-maiden',
      category: 'skin',
      name: '鹤羽仙姬',
      price: 3280,
      accent: '#e08b8a',
      description: '翩若惊鸿，优雅中兼具守护力。',
      skinClass: 'skin-sakura',
      skinIcon: '🪽',
      skinImage: '/assets/skins/skin-12.png',
      rarity: 'legendary',
      theme: '仙灵',
    },
    {
      ...
      skinClass: 'skin-sunrise',
      skinIcon: '🐒',
      skinImage: '/assets/skins/skin-17.png',
      rarity: 'legendary',
      theme: '神话',
    },
    {
      ...
      skinClass: 'skin-sakura',
      skinIcon: '🕊',
      skinImage: '/assets/skins/skin-18.png',
      rarity: 'legendary',
      theme: '仙灵',
    },
    {
      ...
      skinClass: 'skin-storm',
      skinIcon: '🐲',
      skinImage: '/assets/skins/skin-21.png',
      rarity: 'legendary',
      theme: '瑞兽',
    },
  ],
  pet: [
    {
      ...
      petIcon: '🐯',
      petLabel: '小虎',
      petImage: '/assets/111/pets/xiaohu.png',
    },
    {
      id: 'pet-fulu',
      category: 'pet',
      ...
      petIcon: '🦌',
      petLabel: '福鹿',
      petImage: '/assets/111/pets/fulu.png',
    },
    {
      id: 'pet-dragon',
      category: 'pet',
      ...
      petIcon: '🐉',
      petLabel: '淘气龙',
      petImage: '/assets/111/pets/taoqilong.png',
    },
    {
      id: 'pet-luckycat',
      category: 'pet',
      ...
      petIcon: '🐱',
      petLabel: '招财猫',
      petImage: '/assets/111/pets/zhaocaimao.png',
    },
    {
      id: 'pet-xiongmao',
      category: 'pet',
      ...
      petIcon: '🐼',
      petLabel: '熊猫',
      petImage: '/assets/111/pets/xiongmao.png',
    },
    {
      id: 'pet-yutu',
      category: 'pet',
      ...
      petIcon: '🐇',
      petLabel: '玉兔',
      petImage: '/assets/111/pets/yutu.png',
    },
    {
      id: 'pet-jinli',
      category: 'pet',
      ...
      petIcon: '🐟',
      petLabel: '锦鲤',
      petImage: '/assets/111/pets/jinli.png',
    },
    {
      id: 'pet-fox',
      category: 'pet',
    ...
    },
    {
      ...
      petIcon: '🕊',
      petLabel: '仙鹤',
      petImage: '/assets/111/pets/xianhe.png',
    },
    {
      ...
      petIcon: '🐦',
      petLabel: '小凤凰',
      petImage: '/assets/111/pets/xiaofenghuang.png',
    },
    {
      id: 'pet-ruiquan',
      category: 'pet',
      ...
      petIcon: '🐶',
      petLabel: '瑞犬',
      petImage: '/assets/111/pets/ruiquan.png',
    },
    {
      id: 'pet-momao',
      category: 'pet',
      ...
      petIcon: '🐈',
      petLabel: '墨猫',
      petImage: '/assets/111/pets/momao.png',
    },
  ],
};
